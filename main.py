...
VkID = "*" # Вместо звёздочки вставьте ваш вк айди
CreatorName = "*" # Вместо звёздочки вставьте ваше имя и фамилию
bot_token = "*"  # Вместо звёздочки вставьте ваш токен бота
chat_id = "*" # Вместо звёздочки вставьте ваш чат айди
...
def about(commands):
    bot.send_message(chat_id, "Distance control bot \n\nCoded by " + CreatorName + "\n\n vk.com/" + VkID)
